...
public class SrtTextHelper
{
	...
	{
		return BasicFileUtil.getFileParent(srtFilePath) + File.separator + TextFormatUtil.getFileNameNoExtend(srtFilePath);
	}

	public static String getSrtVoiceLocation(String srtFilePath, SrtInfo srtInfo)
	{
		return getSrtVoiceFolder(srtFilePath) + File.separator + srtInfo.getFromTime().toString().replace(":", "") + ".mp3";
	}
