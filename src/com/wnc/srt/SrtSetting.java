...
public class SrtSetting
{
	...
	{
		return Boolean.valueOf(SharedPreferenceUtil.getShareDataByKey(PLAYVOICE, "false"));
	}
	...
	{
		return Boolean.valueOf(SharedPreferenceUtil.getShareDataByKey(AUTOPLAYNEXT, "false"));
	}
