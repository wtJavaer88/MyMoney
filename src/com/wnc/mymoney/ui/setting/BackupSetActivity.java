...
public class BackupSetActivity extends Activity implements OnClickListener
{
	...
	private void initView()
	{
		...
		toggle.setToggleState(Setting.isBackupAuto());
		...
		backupWayComb.setListViewOnClickListener(new ListViewItemClickListener()
		{
			@Override
			public void onItemClick(int position)
			{
				Setting.setBACKUP_WAY(backupWayComb.getText().toString());
			}
		});
		backupFreComb.setListViewOnClickListener(new ListViewItemClickListener()
		{
			@Override
			public void onItemClick(int position)
			{
				Setting.setBACKUP_TIME_MODEL(backupFreComb.getText().toString());
			}
		});
	}
