...
public class ClickablePicRichText
{
    ...
    public CharSequence getPicCharSequence()
    {
        ...
        spanString.setSpan(new Clickable(), 0, 1,
                Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        spanString.setSpan(imgSpan, 1, 5, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spanString.setSpan(new Clickable(), 5, 6,
                Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        return spanString;
    }
    ...
    class Clickable extends ClickableSpan implements OnClickListener
    {
        ...
        public void onClick(View v)
        {
            if (activity != null)
            {
                try
                {
                    Log.i("linkfile", picUrl);
                    Intent intent = getImageFileIntent(picUrl);
