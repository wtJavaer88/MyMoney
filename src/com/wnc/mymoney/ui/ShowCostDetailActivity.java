...
public class ShowCostDetailActivity extends DataViewActivity implements View.OnClickListener
{
	...
	public void initData()
	{
		...
		this.mData.clear();
		List<DayTranTotal> totals = TransactionsDao.getAllTranTotalForChart(costLevel, this.dayRange.getStartDay(), this.dayRange.getEndDay());
		...
		MyListViewAdapter adapter = new MyListViewAdapter(this, this.mData, costLevel);
	...
	{
		startActivity(new Intent(this, MonthPieChartActivity.class).putExtra("costlevel", costLevel).putExtra("dayrange", dayRange));
	}
