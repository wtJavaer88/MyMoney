...
public class MainActivity extends Activity implements UncaughtExceptionHandler
{
    ...
    private void initComponents()
    {
        ...
        String[] menus = new String[] {"nav_yeartrans_tv", "nav_account_tv",
                "nav_report_tv", "nav_budget_tv", "nav_setting_tv",
                "add_expense_quickly_btn"};
        ...
        String[] layouts = new String[] {"month_expense_ly", "today_row_rl",
                "week_row_rl", "month_row_rl"};
    ...
    private void setViewsIfChange()
    {
        ...
        ((TextView)findViewById( R.id.income_amount_tv ))
                .setText( "" + TextFormatUtil.getFormatMoneyStr(
                        OnStartUpDataUtil.getCurrMonthInBound() ) );
        ((TextView)findViewById( R.id.expense_amount_tv ))
                .setText( "" + TextFormatUtil.getFormatMoneyStr(
                        OnStartUpDataUtil.getCurrMonthOutBound() ) );

        LIMIT_PERWEEK = Setting.getBudget();
        LIMIT_PERMONTH = LIMIT_PERWEEK * 4;
        ((TextView)findViewById( R.id.week_balance_amount_tv ))
                .setText( "" + TextFormatUtil.getFormatMoneyStr( LIMIT_PERWEEK
                        - OnStartUpDataUtil.getCurrWeekOutBound() ) );
        ((TextView)findViewById( R.id.month_balance_amount_tv ))
                .setText( "" + TextFormatUtil.getFormatMoneyStr( LIMIT_PERMONTH
                        - OnStartUpDataUtil.getCurrMonthOutBound() ) );

        ((TextView)findViewById( R.id.today_expense_amount_tv ))
                .setText( "" + TextFormatUtil.getFormatMoneyStr(
                        OnStartUpDataUtil.getCurrDayOutBound() ) );
        ((TextView)findViewById( R.id.today_income_amount_tv ))
                .setText( "" + TextFormatUtil.getFormatMoneyStr(
                        OnStartUpDataUtil.getCurrDayInBound() ) );
        ((TextView)findViewById( R.id.week_expense_amount_tv ))
                .setText( "" + TextFormatUtil.getFormatMoneyStr(
                        OnStartUpDataUtil.getCurrWeekOutBound() ) );
        ((TextView)findViewById( R.id.week_income_amount_tv ))
                .setText( "" + TextFormatUtil.getFormatMoneyStr(
                        OnStartUpDataUtil.getCurrWeekInBound() ) );
        ((TextView)findViewById( R.id.month_expense_amount_tv ))
                .setText( "" + TextFormatUtil.getFormatMoneyStr(
                        OnStartUpDataUtil.getCurrMonthOutBound() ) );
        ((TextView)findViewById( R.id.month_income_amount_tv ))
                .setText( "" + TextFormatUtil.getFormatMoneyStr(
                        OnStartUpDataUtil.getCurrMonthInBound() ) );

        ((TextView)findViewById( R.id.month_tv ))
                .setText( "" + BasicDateUtil.getCurrentMonth() );
        ((TextView)findViewById( R.id.year_tv ))
                .setText( "/" + BasicDateUtil.getCurrentYearString() );
        ...
        if ( flag )
        {
            ...
            final Thread thread = new Thread( new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    {
                        backupHandler
                                .sendEmptyMessage( MESSAGE_BACKUP_SUCCESS );
                    } else
                    {
    ...
    {
        BackupTimeModel timeModel = Setting.getBackupTimeModel().equals( "每次" )
                ? BackupTimeModel.TIMELY
                : BackupTimeModel.DAILY;
        NetChannel way = Setting.getBackupWay().equals( "邮箱" )
                ? NetChannel.EMAIL
                : NetChannel.SHARE;
