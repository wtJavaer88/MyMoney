...
public class SysInit
{
	...
	public static void init(Activity context2)
	{
		...
		MyAppParams.getInstance().setScreenWidth(context.getWindowManager().getDefaultDisplay().getWidth());
		MyAppParams.getInstance().setScreenHeight(context.getWindowManager().getDefaultDisplay().getHeight());
	...
	private static boolean isFirstRun()
	{
		...
		boolean isFirstRun = sharedPreferences.getBoolean("isMoneyFirstRun", true);
