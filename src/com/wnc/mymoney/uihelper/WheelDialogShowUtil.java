...
public class WheelDialogShowUtil
{
	...
	public static void showTimeDialog(Context context, int[] defaultIndex, final AfterWheelChooseListener listener)
	{
		final AlertDialog dialog = new AlertDialog.Builder(context).create();
		// dialog.setTitle(title);
	 ...
	 * @param listener
	 */
	public static void showSelectDialog(Context context, String title, final List<MyWheelBean> leftList, final Map<MyWheelBean, List<? extends MyWheelBean>> rightMap, final AfterWheelChooseListener listener)
	{
	 ...
	 * @param listener
	 */
	public static void showSelectDialog(Context context, String title, final List<MyWheelBean> leftList, final Map<MyWheelBean, List<? extends MyWheelBean>> rightMap, int leftId, int rightId, final AfterWheelChooseListener listener)
	{
		...
		showSelectDialog(context, title, leftArr, rightArr, leftId, rightId, listener);
	}

	public static void showSelectDialog(Context context, String title, final String[] left, final String[][] right, int defaultLeftId, int defaultRightId, final AfterWheelChooseListener listener)
	{
		final AlertDialog dialog = new AlertDialog.Builder(context).create();
		// dialog.setTitle(title);
